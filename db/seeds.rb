...
list2 = List.create(user_id: 2, activity_id: 2, description: 'Refrain from shaving in November',location: 'Flatiron School')
list3 = List.create(user_id: 1, activity_id: 3, description: 'Jump off a plane with no parachute',location: 'New York')
list4 = List.create(user_id: 2, activity_id: 4, description: 'Fly through the air in a squirrelsuit',location: 'Switzerland')

list5 = List.create(user_id: 2, activity_id: 5, description: 'Learn how to surf',location: 'the Philippines')
list6 = List.create(user_id: 2, activity_id: 6, description: 'Travel to Madascar',location: 'Madascar')
list7 = List.create(user_id: 2, activity_id: 7, description: 'Star gaze',location: 'a National Park')
list8 = List.create(user_id: 2, activity_id: 8, description: 'Scuba Dive',location: 'the Great Barrier Reef')
...
list11 = List.create(user_id: 2, activity_id: 11, description: 'Go on a hike',location: 'the Milford Track, New Zealand')
list12 = List.create(user_id: 2, activity_id: 12, description: 'Base jump',location: 'New Zealand')
list13 = List.create(user_id: 2, activity_id: 13, description: 'Go white water rafting',location: 'the Grand Canyon')
list14 = List.create(user_id: 2, activity_id: 14, description: 'Dog sled',location: 'Finland')
list15 = List.create(user_id: 2, activity_id: 15, description: 'Climb a mountain',location: 'Colorado')
list16 = List.create(user_id: 2, activity_id: 16, description: 'Learn to snowboard',location: 'Utah')
list17 = List.create(user_id: 2, activity_id: 17, description: 'Go cliff diving',location: 'Croatia')
list18 = List.create(user_id: 2, activity_id: 18, description: 'Drive on the Autobahn',location: 'Germany')
list19 = List.create(user_id: 2, activity_id: 19, description: 'Go on a multi day camping trip',location: 'the United States')
list20 = List.create(user_id: 2, activity_id: 20, description: 'Go bouldering',location: 'New York')
